...
#define TN_FFN_GATE_1      "%s.blk.%d.ffn_gate_1.%s"
...
#define TN_CONV_PW_MID     "%s.blk.%d.conv_pw_mid.%s"
#define TN_LINEAR_POS      "%s.blk.%d.linear_pos.%s"
#define TN_REL_ATTN_BIAS   "a.rel_attn_bias"
#define TN_GLOBAL_MEAN     "a.global_mean"
#define TN_GLOBAL_INVSTD   "a.global_invstd"
#define TN_CONV_GLU_B1     "%s.blk.%d.conv_glu_b1"
#define TN_CONV_GLU_B2     "%s.blk.%d.conv_glu_b2"
